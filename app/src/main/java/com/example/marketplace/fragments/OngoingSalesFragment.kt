...
import com.example.marketplace.adapters.OngoingSalesDataAdapter
...
class OngoingSalesFragment : Fragment(), OngoingSalesDataAdapter.OnItemClickListener{
    private lateinit var removeOrderViewModel: RemoveOrderViewModel
    private lateinit var recycler_view: RecyclerView
    private lateinit var adapter: OngoingSalesDataAdapter
    ...
    private fun setupRecyclerView(){
        adapter = OngoingSalesDataAdapter(ArrayList<Order>(), this.requireContext(),this)
    ...
    override fun onDeleteClick(position: Int) {
        ...
        dialogBuilder.setMessage("Do you want to delete this Order?")
            .setPositiveButton("Yes!  ", DialogInterface.OnClickListener { dialog, id ->
                ...
                findNavController().navigate(R.id.action_ongoingSalesFragment_self)
            })
